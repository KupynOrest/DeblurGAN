...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--loadSizeX', type=int, default=960, help='scale images to this size')
		self.parser.add_argument('--loadSizeY', type=int, default=540, help='scale images to this size')
